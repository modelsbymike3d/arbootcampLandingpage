...
export default () => (
  <>
    ...
    <Layout>
      ...
      <TextBlock id="perks" title="All backgrounds, all skill levels">
        <p>
          {`Developer? Designer? Artist? We've got you covered. Each tutorial walks you through step-by-step, and we go into plenty of depth for those already experienced in augmented reality. And did we mention it's all 100% free?`}
        </p>
